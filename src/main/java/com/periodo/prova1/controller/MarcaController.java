...
import com.periodo.prova1.service.MarcaService;
...
public class MarcaController {
    ...
    @PostMapping
    public ResponseEntity<?> saveMarca(@RequestBody Marca marca) throws Exception {
        try {
            Marca marcaSaved = marcaService.saveMarca(marca);
